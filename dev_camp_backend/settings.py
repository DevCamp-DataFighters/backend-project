"""
Django settings for dev_camp_backend project.
...
SECRET_KEY = 'django-insecure-wox0^gla-oce_ad7fb7&*=qbz=us9ntudmak1vci_jp*lkr$l1'
...
WSGI_APPLICATION = 'dev_camp_backend.wsgi.application'
